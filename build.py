...
def get_personal_data():
    ...
    footer = """
            <div class="col-sm-12" style="">
                <h4>Teaching</h4>
                <p>Teaching assistant at EPFL:</p>
                <ul>
                    <li><a href="https://edu.epfl.ch/coursebook/en/analysis-iv-for-el-gm-mx-MATH-207-C" target="_blank">MATH-207(c): Analysis IV</a></li>
                    <li><a href="https://edu.epfl.ch/coursebook/en/applied-data-analysis-CS-401" target="_blank">CS-401: Applied Data Analysis</a></li>
                    <li><a href="https://edu.epfl.ch/coursebook/en/fundamentals-of-inference-and-learning-EE-411" target="_blank">EE-411: Fundamentals of Inference and Learning</a></li>
                </ul>
            </div>
    """
...
def generate_person_html(persons, connection=", ", make_bold=True, make_bold_name='Xiaohang Yu', add_links=True):
...
def get_talk_entry(entry_key, entry):
    ...
    artefacts = {'slides': 'Pdf', 'video': 'Recording'}
    i = 0
    for (k, v) in artefacts.items():
        if k in entry.fields.keys():
            if i > 0:
...
<head>
  ...
  <style>
    .profile-card {{ max-width: 190px; margin-left: auto; margin-right: auto; }}
    .profile-card img {{ width: 100%; border-radius: 6px; }}
    .profile-links {{ display: flex; justify-content: space-between; margin: 0.8em 0.15em 1em; font-size: 1.3em; }}
    .profile-link {{ color: #555; transition: color 0.15s; }}
    .profile-link:hover {{ color: #007bff; text-decoration: none; }}
  </style>
                ...
                <div class="row" style="margin-top: 3em;">
                    ...
                    <div class="col-md-3 profile-card">
                        ...
                        <div class="profile-links">
                            <a class="profile-link" href="assets/pdf/cv.pdf" target="_blank" title="CV" aria-label="CV"><i class="fa-solid fa-file-lines"></i></a>
                            <a class="profile-link" href="mailto:xiaohang.yu@epfl.ch" title="Mail" aria-label="Mail"><i class="fa-solid fa-envelope"></i></a>
                            <a class="profile-link" href="https://scholar.google.com/citations?user=Gi_MoOsAAAAJ&hl=zh-CN" target="_blank" title="Scholar" aria-label="Scholar"><i class="fa-solid fa-graduation-cap"></i></a>
                            <a class="profile-link" href="https://github.com/lexiyutou" target="_blank" title="GitHub" aria-label="GitHub"><i class="fa-brands fa-github"></i></a>
                            <a class="profile-link" href="https://www.linkedin.com/in/xiaohang-yu-091184324/" target="_blank" title="LinkedIn" aria-label="LinkedIn"><i class="fa-brands fa-linkedin"></i></a>
                        </div>
                    </div>
                </div>
